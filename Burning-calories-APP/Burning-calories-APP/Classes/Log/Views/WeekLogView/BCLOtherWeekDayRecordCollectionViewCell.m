//
//  BCLOtherWeekDayRecordCollectionViewCell.m
...
@implementation BCLOtherWeekDayRecordCollectionViewCell
- (instancetype) initWithFrame:(CGRect)frame {
    if(self = [super initWithFrame:frame]) {
        ...
        _weekOfTimeLabel.textColor = [UIColor blackColor];
        ...
        [_everydayCaloriesLabel mas_makeConstraints:^(MASConstraintMaker *make) {
            make.left.equalTo(self.weekFoodImageView.mas_left);
            make.top.equalTo(self.weekOfTimeLabel.mas_bottom).offset(2);
        ...
        [self.shareButton mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.bottom.equalTo(self).offset(-kMarginWeek);
