...
//        [self.layer addSublayer:gradientLayer];
        ...
        backImageView.frame = backgroundView.frame;
        backImageView.image = [UIImage imageNamed:@"bcl_bg_log_month_allCell"];
        ...
        _chartView.bounds = CGRectMake(0, 0, self.bounds.size.width - 50, 140);
