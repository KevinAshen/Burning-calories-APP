...
@implementation BCLImagePreviewView
...
- (instancetype) initWithFrame:(CGRect)frame {
    ...
    if(self) {
        ...
        // 页面控制
        _pageControl = [[UIPageControl alloc] initWithFrame:CGRectMake(0, self.frame.size.height-(k_iphone_x?80:40), k_screen_width, 20)];
...
@implementation BCLPreScrollView
- (instancetype) initWithFrame:(CGRect)frame {
    self = [super initWithFrame:frame];
    if(self) {
